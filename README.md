...
| `--slow`              | `-w`  | \-       | Завантажує розділи один за одним.                    |
...
При завантаженні великої кількості розділів за раз, сайт може відмовляти в обслуговуванні. В такому разі слід використовувати опцію `--slow` - вона збільшує час очікування перед завантаженням кожного розділу, що зменшує ймовірність досягнення ліміту запитів.
